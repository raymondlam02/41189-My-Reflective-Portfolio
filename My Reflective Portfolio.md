...
This week, again Juan gave us the opportunity to work on our assignments in prepreation for the final submission date. Our group continued to work on the assignment whilst in contact with Juan for assistance with JupiterNotebook and Python coding. As our whole group was unfamilar with Python, the code and its subsequent actions made little to no sense to us. We were encouraged to use a pre-existing piece of code then modify as required. However, we were having issues running the pre-existing code. Juan read through the code, however we asked him towards the end of the workshop. He was able to get back to us in the following days and we were able to start using Python to model the effects of Covid-19 as requried for the task. I found this week's workshop extremely productive for our group as we were able to achieve a lot, although it may not be evident immediatly as we were not able to materialise some of the concepts and ideas during that workshop, we discussed ideas and ways we could answer each question. I feel this weeks QnA session in the workshop was extremely valueable to our group as we were able to realise what each question was asking. This will hopefully result in a better performance in the final assessment. 
